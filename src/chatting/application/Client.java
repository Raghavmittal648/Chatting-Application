...
public class Client   implements ActionListener{
    ...
    Client(){
        ...
        JLabel morevet = new JLabel(i15);
        morevet.setBounds(420, 20, 10, 25);
        p1.add(morevet);
        
        //NAME
        
        JLabel name = new JLabel("Raghave");
    ...
    try{
      ...
      // creat p2 lable to add  string out into JPanel 
    ...
    public static  JPanel formatLabel (String out){
        ...
        JLabel output = new JLabel("<html><p style=\"width:150px\">"
                + out+"</p></html>");
